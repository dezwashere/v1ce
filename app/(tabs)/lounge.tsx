...
export default function Lounge(){
 ...
 return <ScrollView style={{backgroundColor:c.background}} contentContainerStyle={s.container}>
  ...
  <Text style={[s.section,{color:c.foreground}]}>ARCADE</Text><View style={s.arcadeRow}><TouchableOpacity onPress={()=>router.push({pathname:"/game",params:{game:"run"}})} style={[s.gameCard,{borderColor:c.foreground}]}><Text style={[s.gameTitle,{color:c.foreground}]}>SOBRIETY RUN</Text><Text style={{color:c.mutedForeground,fontSize:10,marginTop:4}}>12 LEVELS · BOSS FIGHT</Text><Text style={{color:c.foreground,fontWeight:"900",marginTop:10}}>PLAY →</Text></TouchableOpacity><TouchableOpacity onPress={()=>router.push({pathname:"/game",params:{game:"snake"}})} style={[s.gameCard,{borderColor:c.foreground}]}><Text style={[s.gameTitle,{color:c.foreground}]}>JAYWALKER</Text><Text style={{color:c.mutedForeground,fontSize:10,marginTop:4}}>SNAKE · POWER-UPS</Text><Text style={{color:c.foreground,fontWeight:"900",marginTop:10}}>PLAY →</Text></TouchableOpacity></View>
